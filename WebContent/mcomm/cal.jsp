...
<%
		...
		while(nNoOfMonths > 0)
		{
			...
			while(!c_temp.after(c_end))
			{
				...
				out.print("><a href='javascript:window.close();' style='text-decoration: none; color: #000000; font-size: 8pt' onClick='opener.document.formini.dari.value=\""+c_temp.get(c_temp.DAY_OF_MONTH)+"-"+(c_temp.get(c_temp.MONTH)+1)+"-"+c_temp.get(c_temp.YEAR)+"\"'>");

	...
	if(msisdn != null)
	{
			...
			try {
				conn = DbCon.getConnection();
			 	String sql = "select c.msisdn, tx_id,t.acc_no, x.description as tx_tipe,debet,credit,balance,tx_date,loading_terminal_id,payment_terminal_id,t.description as description, ref_num, r.msisdn as mmsisdn from customer c,tsel_cust_account_history t, reader_terminal r, trx_type_table x where c.acc_no = t.acc_no and c.msisdn = ? and to_char(r.terminal_id(+)) = t.payment_terminal_id and x.trx_type=t.tx_tipe and ( tx_date between to_date('"+dari+" 00:00:00', 'DD-MM-YYYY HH24:MI:SS') and to_date('"+ampe+" 23:59:59', 'DD-MM-YYYY HH24:MI:SS')) order by t.tx_date desc, t.ref_num desc, t.tx_id desc"; 

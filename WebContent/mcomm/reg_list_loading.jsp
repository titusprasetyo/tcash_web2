...
<jsp:useBean id="DbCon" scope="page" class="tsel_tunai.DbCon"></jsp:useBean>
	...
	%>
        ...
        <table width="21%" border="0" cellspacing="0" cellpadding="0">
          <form name="form" method="post" action="reg_list_loading.jsp">
            <tr bgcolor="#CC6633"> 
...
// paging stuff
String sql = "select count(*) as jumlah from merchant m,merchant_info mi where m.merchant_info_id = mi.merchant_info_id and name like '%"+name+"%'";
...
// end of paging stuff
		 	...
		 	sql = "select * FROM (select a.*, ROWNUM rnum from (" +
		 				"select name,merchant_id from merchant m,merchant_info mi where m.merchant_info_id = mi.merchant_info_id and name like '%"+name+"%'" + 
          ...
          <tr> 
            ...
            <td bgcolor="#EEEEEE"><div align="center"><font color="black" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="reg_loading.jsp?stat=0&mid=<%= rs.getString("merchant_id")%>" class="link">Create</a></font></div></td>
          </tr>
          <%
			}
			pstmt.close();

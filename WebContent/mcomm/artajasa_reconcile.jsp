...
<stripes:layout-render name="/web-starter/layout/standard.jsp" title="Artajasa Reconcile">
	<stripes:layout-component name="contents">
		...
		1. <a href='/uploadArtajasaRPT.jsp?idLog1=<%=encLogin%>&idLog2=<%=encPass%>'>Artajasa RPT</a> | 2. <a href='/uploadArtajasaRTG.jsp?idLog1=<%=encLogin%>&idLog2=<%=encPass%>'>Artajasa RTG</a> | 3. <a href='/uploadArtajasaRTS.jsp?idLog1=<%=encLogin%>&idLog2=<%=encPass%>'>Artajasa RTS</a> | 4. <a href='artajasa_reconcile_detail.jsp?_sourcePage=%2Fmcomm%2Fartajasa_reconcile.jsp'>Artajasa Recon Detail</a>  | 5. <a href='https://10.2.114.121:9082/tcash-web/mcomm/history_kewajiban.jsp'>History Hak/Kewajiban</a>
		<hr />

...
<stripes:layout-render name="/web-starter/layout/standard.jsp" title="Edit Crew">
    <stripes:layout-component name="contents">
        <stripes:form action="/smscrew/crew/EditCrew.action">
            <stripes:errors/>
			<table class="leftRightForm">
				<tr>
                    <th>ID Crew:</th>
                    <td><stripes:text value="${id}" name="id" readonly="true"/></td>
                </tr>
                <tr>
                    <th>Name:</th>
            ...
            <div class="buttons">
                <stripes:submit name="view" value="Edit"/>
            </div>
        </stripes:form>
        <br/>

				...
				<table width="90%" border="1" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<div align="center"><font color="#FFFFFF" size="2"
							face="Verdana, Arial, Helvetica, sans-serif">Token</font></div>
						</td>
					</tr>
					<tr>
						<td align="center">
						<table width="90%" border="0" cellspacing="0" cellpadding="0">
							<form action="authToken.jsp" method="GET">
								<tr>

									<td width="40%"><font color="#CC6633" size="1"
										face="Verdana, Arial, Helvetica, sans-serif"><strong>username</strong></font></td>
									<td align="right"><input type="text" name="username" disabled="true"/></td>
								</tr>
								<tr>
									<td><font color="#CC6633" size="1"
										face="Verdana, Arial, Helvetica, sans-serif"><strong>Token</strong></font></td>
									<td align="right"><input type="password" name="token"/></td>
								</tr>
								<tr>
									<td>&nbsp;</td>

...
<stripes:layout-render name="/web-starter/layout/standard.jsp" title="Cashout Approval">
	<stripes:layout-component name="contents">
		<hr />New Feature : <br />
		<a href='bulk_payment_csv.jsp'>Bulk Payment CSV Maker</a> | <a href='https://10.2.114.121:9082/new_uploadPaymentStatus.jsp?idLog1=<%=encLogin%>&idLog2=<%=encPass%>'>Upload Payment CSV</a> 
		<hr />
